...
const struct stat_col stat_cols_px[ST_I_PX_MAX] = {
	...
	[ST_I_PX_QCUR]                          = { .name = "qcur",                        .desc = "Number of current queued connections", .cap = STATS_PX_CAP___BS },
	[ST_I_PX_QMAX]                          = { .name = "qmax",                        .desc = "Highest value of queued connections encountered since process started", .cap = STATS_PX_CAP___BS },
	...
	[ST_I_PX_NEED_CONN_EST]                 = { .name = "need_conn_est",               .desc = "Estimated needed number of connections", .cap = STATS_PX_CAP____S},
	[ST_I_PX_UWEIGHT]                       = { .name = "uweight",                     .desc = "Server's user weight, or sum of active servers' user weights for a backend", .cap = STATS_PX_CAP___BS },
	[ST_I_PX_AGG_SRV_CHECK_STATUS]          = { .name = "agg_server_check_status",     .desc = "[DEPRECATED] Backend's aggregated gauge of servers' status", .cap = STATS_PX_CAP___B_ },
	[ST_I_PX_AGG_SRV_STATUS ]               = { .name = "agg_server_status",           .desc = "Backend's aggregated gauge of servers' status", .cap = STATS_PX_CAP___B_ },
